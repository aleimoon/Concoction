...
public class CordycepsSpiderEntity extends Spider {

    public CordycepsSpiderEntity(EntityType<? extends Spider> type, Level world) {
        super(type, world);
    }
    ...
    static class MoveToSkyGoal extends net.minecraft.world.entity.ai.goal.Goal {
        private final CordycepsSpiderEntity spider;
        private BlockPos targetPos;

        public MoveToSkyGoal(CordycepsSpiderEntity spider) {
            this.spider = spider;
