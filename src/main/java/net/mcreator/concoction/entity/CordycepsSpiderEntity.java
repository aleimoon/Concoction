...
public class CordycepsSpiderEntity extends Monster {
	public CordycepsSpiderEntity(EntityType<CordycepsSpiderEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ConcoctionModEntities.CORDYCEPS_SPIDER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
